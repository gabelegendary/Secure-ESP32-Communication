...
class Session:
    ...
    def __init__(self, port):
        self.serial_connection = serial_communication.initialize_serial(port)
        self.SESSION_ID = b''
        ...
        serial_communication.initialize_serial(port)
    ...
    def send(self, buf: bytes) -> bool:
        ...
        return serial_communication.send_data(buf)

    def receive(self, size: int) -> bytes:
        buffer = serial_communication.receive_data(size + self.HMAC_CS.digest_size)
